...
import { renderCreator, sendToCreator, doCheckWord, inspectSensitiveHtml, analyzeRewriteHotspots, openActionLogs, renderRewriteHotspots, selectRewriteHotspot, clearSelectedHotspot, doRewrite, copyRewrite, exportToKb, generateCover, clearCreatorSource, toggleCreatorTool } from './pages/creator.js';
...
registerAction('toggleCreatorTool', (_, d) => toggleCreatorTool(_, d));
